...
document.getElementById("choropleth").onclick = function() {choropleth()};
document.getElementById("clouds").onclick = function() {clouds()};
document.getElementById("custom").onclick = function() {custom()};
document.getElementById("customlayer").onclick = function() {customlayer()};
document.getElementById("earthShield").onclick = function() {earthShield()};
document.getElementById("earthquakes").onclick = function() {earthquakes()};
document.getElementById("emitArcs").onclick = function() {emitArcs()};
document.getElementById("heatmaps").onclick = function() {heatmaps()};
document.getElementById("hexedPolygons").onclick = function() {hexedPolygons()};
document.getElementById("hollowGlobe").onclick = function() {hollowGlobe()};
document.getElementById("htmlMarkers").onclick = function() {htmlMarkers()};
document.getElementById("moonLandingSites").onclick = function() {moonLandingSites()};
document.getElementById("populationHeatmap").onclick = function() {populationHeatmap()};
document.getElementById("randomArcs").onclick = function() {randomArcs()};
document.getElementById("randomPaths").onclick = function() {randomPaths()};
document.getElementById("randomRings").onclick = function() {randomRings()};
document.getElementById("satellites").onclick = function() {satellites()};
document.getElementById("solarTerminator").onclick = function() {solarTerminator()};
document.getElementById("submarineCables").onclick = function() {submarineCables()};
document.getElementById("tiles").onclick = function() {tiles()};
document.getElementById("worldVolcanoHeatmap").onclick = function() {worldVolcanoHeatmap()};
document.getElementById("volcanoes").onclick = function() {volcanoes()};
document.getElementById("worldCities").onclick = function() {worldCities()};
document.getElementById("worldPopulation").onclick = function() {worldPopulation()};
